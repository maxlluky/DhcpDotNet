...
class DhcpRequestPacket
{
    ...
    //--clientIdentifier
    public byte[] clientIdentifierPre { get; set; } = new byte[3] { 0x3d, 0x07, 0x01 };
    //--clientIdentifier
    ...
    public byte[] dhcpServerIdentifier { get; set; } = new byte[6] { 0x36, 0x04, 0xc0, 0xa8, 0xb2, 0x01 };
